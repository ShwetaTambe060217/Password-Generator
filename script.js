...
let passInfo = "";
const passChars = [];
// asking user for the length of their password
  let characterAmount = window.prompt("Enter the amount of characters you want for your password. It should be between 8-128 characters");
  ...
  if (characterAmount >= 8 && characterAmount < 129) {
    ...
    if (getInteger) {
      // add numerical characters to password
